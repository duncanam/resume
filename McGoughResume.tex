...
\name{Duncan McGough}
\address{(605)~$\cdot$~484~$\cdot$~3043 \quad \\ \quad duncan.mcgough@colorado.edu \quad \\ \quad  \url{duncanam.github.io}} 
...
Programming & Python, MATLAB, Julia, C++, LABVIEW, \LaTeX  \\
	Software & ANSYS, Thermal Desktop, CFD (OpenFOAM), CAD (SolidWorks, NX),  Microsoft Office Suite \\
...
Personal Interests & Violin, tuner car modification, freeride skiing, mountain biking, martial arts \\
\end{tabular}
}
\end{rSection}
